...
const HabitIcon = ({ type, color }: { type: string; color: string }) => {
  const iconClasses = `w-12 h-12 ${color}`;
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <section className="mb-16">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-8 italic ml-4">
          Develops leadership qualities and mental fortitude required for long-term success.
        </p>

        <div className="grid gap-6">
          <div className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              <div className="flex-shrink-0 text-blue-600 dark:text-blue-400">
                <HabitIcon type="book" color="text-blue-600 dark:text-blue-400" />
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-lg text-blue-900 dark:text-blue-100 mb-2">1. Read Daily (15–30 Minutes)</h3>
          ...
          <div className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-blue-900 dark:text-blue-100 mb-2">2. Listen to Audios/Podcasts Daily</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-blue-900 dark:text-blue-100 mb-2">3. Subscribe to the Podcasting App</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-blue-900 dark:text-blue-100 mb-2">4. Attend All Functions</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
      ...
      <section className="mb-16">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-1 h-10 bg-gradient-to-b from-green-600 to-green-400 rounded-full"></div>
        ...
        <div className="grid gap-6">
          <div className="group bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/20 rounded-xl p-6 border border-green-200 dark:border-green-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              <div className="flex-shrink-0 text-green-600 dark:text-green-400">
                <HabitIcon type="checkmark" color="text-green-600 dark:text-green-400" />
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-lg text-green-900 dark:text-green-100 mb-2">5. Be a Product of the Product</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="group bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/20 rounded-xl p-6 border border-green-200 dark:border-green-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-green-900 dark:text-green-100 mb-2">6. Develop a Retail Base</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
      ...
      <section className="mb-16">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-1 h-10 bg-gradient-to-b from-purple-600 to-purple-400 rounded-full"></div>
        ...
        <div className="grid gap-6">
          <div className="group bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/20 rounded-xl p-6 border border-purple-200 dark:border-purple-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-purple-900 dark:text-purple-100 mb-2">
                  7. Dropping-The-Message (DTM), Showing-The-Plan (STP), and Follow-Up
                </h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="group bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/20 rounded-xl p-6 border border-purple-200 dark:border-purple-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-purple-900 dark:text-purple-100 mb-2">8. Staying Accountable</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="group bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/20 rounded-xl p-6 border border-purple-200 dark:border-purple-700/50 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-purple-900 dark:text-purple-100 mb-2">9. Counseling</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
